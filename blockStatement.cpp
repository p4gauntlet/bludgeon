    ...
    for (int num_stat = 0; num_stat < max_statements; num_stat++) {
        switch (CODEGEN::randind(percent, 10)) {
            case 0: {
                ...
                if (tab_names.size() > 0) {
                    ...
                    if (P4Scope::called_tables.find(tab_name) ==
                        ...
                        auto mem =
                            new IR::Member(new IR::PathExpression(new IR::Path(
                                                                      IR::ID(
                                                                          tab_name))),
                                           IR::ID("apply"));
            ...
            case 3: {
                if (if_in_ifs == false) {
                    auto func_ass =
                        assignmentOrMethodCallStatement::gen_func_ass();
            ...
            case 4: {
                auto compound_ass =
                    assignmentOrMethodCallStatement::gen_compound_ass();
            ...
            case 5: {
                ...
                if (rand() % 4 == 0) {
                    auto if_stat =
                        conditionalStatement::gen_if_stat(if_in_func);
