...
struct probabilities {
    ...
    short BASETYPE_INT = 0;
    short BASETYPE_STRING = 0;
    short BASETYPE_BIT = 90;
    short BASETYPE_SIGNED_BIT = 0;
    short BASETYPE_VARBIT = 0;
    short BASETYPE_BIT_EXPR = 0;
    short BASETYPE_INT_EXPR = 0;
    short BASETYPE_VARBIT_EXPR = 0;
    ...
    short CONSTANTDECLARATION_BASETYPE_INT = 10;
    short CONSTANTDECLARATION_BASETYPE_STRING = BASETYPE_STRING;
    short CONSTANTDECLARATION_BASETYPE_BIT = 80;
    ...
    short CONSTANTDECLARATION_BASETYPE_BIT_EXPR = BASETYPE_BIT_EXPR;
    short CONSTANTDECLARATION_BASETYPE_INT_EXPR = BASETYPE_INT_EXPR;
    short CONSTANTDECLARATION_BASETYPE_VARBIT_EXPR = BASETYPE_VARBIT_EXPR;
    ...
    short FUNCTIONDECLARATION_BASETYPE_BOOL = 20;
    ...
    short FUNCTIONDECLARATION_BASETYPE_BIT = 80;
    ...
    short FUNCTIONDECLARATION_BASETYPE_BIT_EXPR = BASETYPE_BIT_EXPR;
    short FUNCTIONDECLARATION_BASETYPE_INT_EXPR = BASETYPE_INT_EXPR;
    short FUNCTIONDECLARATION_BASETYPE_VARBIT_EXPR = BASETYPE_VARBIT_EXPR;
    ...
    short HEADERTYPEDECLARATION_BASETYPE_BIT = 100;
    ...
    short HEADERTYPEDECLARATION_BASETYPE_BIT_EXPR = BASETYPE_BIT_EXPR;
    short HEADERTYPEDECLARATION_BASETYPE_INT_EXPR = BASETYPE_INT_EXPR;
    short HEADERTYPEDECLARATION_BASETYPE_VARBIT_EXPR = BASETYPE_VARBIT_EXPR;
    ...
    short PARAMETER_BASETYPE_BIT = 100;
    short PARAMETER_BASETYPE_SIGNED_BIT = BASETYPE_SIGNED_BIT;
    short PARAMETER_BASETYPE_VARBIT = BASETYPE_VARBIT;
    short PARAMETER_BASETYPE_BIT_EXPR = BASETYPE_BIT_EXPR;
    short PARAMETER_BASETYPE_INT_EXPR = BASETYPE_INT_EXPR;
    short PARAMETER_BASETYPE_VARBIT_EXPR = BASETYPE_VARBIT_EXPR;
    ...
    short STRUCTTYPEDECLARATION_BASETYPE_BOOL = 20;
    ...
    short STRUCTTYPEDECLARATION_BASETYPE_BIT = 80;
    ...
    short STRUCTTYPEDECLARATION_BASETYPE_BIT_EXPR = BASETYPE_BIT_EXPR;
    short STRUCTTYPEDECLARATION_BASETYPE_INT_EXPR = BASETYPE_INT_EXPR;
    short STRUCTTYPEDECLARATION_BASETYPE_VARBIT_EXPR = BASETYPE_VARBIT_EXPR;
    // probabilities for types in struct structures
    ...
    short TYPEDEFDECLARATION_BASETYPE_BIT = 100;
    short TYPEDEFDECLARATION_BASETYPE_SIGNED_BIT = BASETYPE_SIGNED_BIT;
    short TYPEDEFDECLARATION_BASETYPE_VARBIT = BASETYPE_VARBIT;
    short TYPEDEFDECLARATION_BASETYPE_BIT_EXPR = BASETYPE_BIT_EXPR;
    short TYPEDEFDECLARATION_BASETYPE_INT_EXPR = BASETYPE_INT_EXPR;
    short TYPEDEFDECLARATION_BASETYPE_VARBIT_EXPR = BASETYPE_VARBIT_EXPR;
    ...
    short VARIABLEDECLARATION_BASETYPE_BOOL = 10;
    ...
    short VARIABLEDECLARATION_BASETYPE_BIT = 90;
    ...
    short VARIABLEDECLARATION_BASETYPE_BIT_EXPR = BASETYPE_BIT_EXPR;
    short VARIABLEDECLARATION_BASETYPE_INT_EXPR = BASETYPE_INT_EXPR;
    short VARIABLEDECLARATION_BASETYPE_VARBIT_EXPR = BASETYPE_VARBIT_EXPR;
};
