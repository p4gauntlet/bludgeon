...
struct probabilities {
    ...
    short CONSTANTDECLARATION_DERIVED_HEADER_STACK = 0;
    ...
    short FUNCTIONDECLARATION_DERIVED_HEADER_STACK = 0;
    ...
    short HEADERTYPEDECLARATION_DERIVED_HEADER = 0;
    short HEADERTYPEDECLARATION_DERIVED_HEADER_STACK = 0;
    //FIXME: Headers should be able to have structs?
    short HEADERTYPEDECLARATION_DERIVED_STRUCT = 0;
    short HEADERTYPEDECLARATION_DERIVED_HEADER_UNION = 0;
    short HEADERTYPEDECLARATION_DERIVED_TUPLE = 0;
    short HEADERTYPEDECLARATION_TYPE_VOID = 0;
    short HEADERTYPEDECLARATION_TYPE_MATCH_KIND = 0;
    ...
    short STRUCTTYPEDECLARATION_TYPE_VOID = 0;
    short STRUCTTYPEDECLARATION_TYPE_MATCH_KIND = 0;
    // probabilities for types in struct structures
