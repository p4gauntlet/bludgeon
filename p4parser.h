...
class p4Parser {
  public:
    ...
    IR::P4Parser *gen_tofino_p() {
        ...
        params.push_back(param);
        param = parameter::gen_param(IR::Direction::Out, "ig_md",
                                     "ingress_metadata_t");
        params.push_back(param);
        ...
        auto extract_tofino_md =
            p4state->gen_hdr_extract(pkt_extract, ig_intr_md);
        ...
        // add to the whole scope
        auto p4parser =
            new IR::P4Parser(*p_name, tp_parser, parserLocals, states);
        P4Scope::add_to_scope(p4parser);
        return p4parser;
    }
};
