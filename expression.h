...
public:
    ...
    static std::vector<IR::AssignmentStatement *> decl_initialize(
    ...
    static IR::Expression *get_operand(int pa_or_var, const IR::Type **tp,
                                       cstring& type, bool if_compound,
    ...
    // e.g. ==, != for cond, =,
    static bool get_two_compound_operands(IR::Expression **expr1,
                                          IR::Expression **expr2,
                                          const IR::Type **tp1,
                                          const IR::Type **tp2);
    static IR::Expression *construct_compound_cond_expr();
    static IR::Vector<IR::Argument> *construct_params(
