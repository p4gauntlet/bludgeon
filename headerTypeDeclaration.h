...
class headerTypeDeclaration {
  public:
    ...
    static IR::Type_Header *gen_eth() {
        ...
        auto eth_dst = new IR::StructField(IR::ID("dst_addr"),
                                           new IR::Type_Bits(48, false));
        auto eth_src = new IR::StructField(IR::ID("src_addr"),
                                           new IR::Type_Bits(48, false));
        auto eth_type = new IR::StructField(IR::ID("eth_type"),
